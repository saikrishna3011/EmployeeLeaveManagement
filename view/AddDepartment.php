				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						...
						<li>
							...
							?>
						<li>
							<a style="color:#DAA520;" href="AddDepartment.php"><i class="fas fa-plus"></i> Add Department</a>
						</li>
						<li>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form role="form" action="../controller/AddDepartmentController.php" method="post" >
									...
									<button type="submit" name="btnSubmit" class="btn btn-success">Add Department</button>
